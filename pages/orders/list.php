...
list($filterSql, $params) = buildListFilterSql(
    $filters,
    ['o.order_no', 'o.subject', 'c.name'],
    'o.order_date',
    'o.status'
);
$sql .= $filterSql . " ORDER BY o.order_date DESC, o.id DESC";
...
<?php renderListFilterForm($filters, $statusLabels, '受注番号・件名・顧客名で検索', '受注日'); ?>
